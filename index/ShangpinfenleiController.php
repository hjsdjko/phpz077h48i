...
class ShangpinfenleiController extends CommonController {
    ...
    public function save(){
        ...
        if (!empty($tmpData)&& isset($tmpData)){
            ...
            $shangpinfenlei = $postData['shangpinfenlei'];
            $resultInfo = table_sql("select shangpinfenlei from `shangpinfenlei` where `shangpinfenlei` = '".$shangpinfenlei."'");
            if ($resultInfo->num_rows > 0) {
                exit(json_encode(['code'=>500,'msg'=>"商品分类已存在"]));
            }
    ...
    public function update(){
        ...
        $postData = json_decode($tmpData,true);
            $shangpinfenlei = $postData['shangpinfenlei'];
            $id = $postData['id'];
            $resultInfo = table_sql("select shangpinfenlei from `shangpinfenlei` where id <> ".$id." and `shangpinfenlei` = '".$shangpinfenlei."'");
            if ($resultInfo->num_rows > 0) {
                exit(json_encode(['code'=>500,'msg'=>"商品分类已存在"]));
            }
        $v = array();

...
class YonghuController extends CommonController {
    ...
    public function login(){
        ...
        $sql = "select * from `yonghu` where `yonghuzhanghao` = '$username'";
            ...
            while($row = $result->fetch_assoc()) {
                ...
                if($row['mima']!=$password){//密码错误
                    ...
                    if($passwordwrongnum>= 3){
                        $sql = "update yonghu set passwordwrongnum = '$passwordwrongnum',status = '1' where yonghuzhanghao = '".$username."'";
                    }else{
                        $sql = "update yonghu set passwordwrongnum = '$passwordwrongnum' where yonghuzhanghao = '".$username."'";
                    }
                    $result = table_sql($sql);

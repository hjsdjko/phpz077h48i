	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#999","background":"#f6f6f6"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="捐款金额" prop="juankuanjine">
					<el-input v-model.number="ruleForm.juankuanjine" placeholder="捐款金额" clearable  :readonly="ro.juankuanjine"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="捐款金额" prop="juankuanjine">
					<el-input v-model="ruleForm.juankuanjine" placeholder="捐款金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="捐款时间" prop="juankuanshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.juankuanshijian" 
						type="datetime"
						:readonly="ro.juankuanshijian"
						placeholder="捐款时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.juankuanshijian" label="捐款时间" prop="juankuanshijian">
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.juankuanjine = parseFloat(objcross.juankuanjine) + parseFloat(this.ruleForm.juankuanjine)
                }
      //更新跨表属性
       var crossuserid;
       var crossrefid;
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `juankuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.juankuanxinxiCrossAddOrUpdateFlag = false;
											this.parent.search();

...
<style lang="scss" scoped>
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
				...
				margin: 0px 16px 0;
				overflow: hidden;
				background: url(http://codegen.caihongy.cn/20231104/fbcb93b3b69948beb7b4e105fa3ee4b8.png) no-repeat 20px top;
				width: calc(100% - 32px);
				font-size: inherit;
			}

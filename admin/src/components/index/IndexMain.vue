<template>
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0 0 0 64px","margin":"0","position":"relative","background":"#f3f3f3","display":"block"} : {"minHeight":"100%","padding":"220px 0 0 200px","margin":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20231103/f07d77fa7f904f4198d374ea3c3a51cc.jpg) no-repeat left top / cover","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<!-- top -->
			<index-header :style='{"padding":"0px 180px 0px 20px","margin":"0 auto","borderColor":"rgba(126, 96, 16, .2)","alignItems":"center","color":"#666","display":"flex","justifyContent":"flex-end","top":"0","left":"0","background":"#ffffff","borderWidth":"0 0 0px","width":"calc(100% - 0px)","fontSize":"14px","position":"fixed","borderStyle":"solid","zIndex":"1","height":"90px"}'></index-header>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"40px 30px 0","margin":"90px auto 0","borderColor":"#eee","top":"70px","borderWidth":"0 0 0px 0","background":"#f6f6f6","width":"calc(100% - 200px)","fontSize":"14px","position":"absolute","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>

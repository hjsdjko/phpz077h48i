<template>
  <div :style='{"width":"100%","padding":"20px 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
    <div class="section-title" :style='{"margin":"10px 0","color":"#333","textAlign":"center","background":"#fff","fontSize":"22px","lineHeight":"54px","fontWeight":"600"}'>确认{{totalPrice>0?'下单':'预订'}}</div>

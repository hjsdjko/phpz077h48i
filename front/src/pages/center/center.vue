...
<div class="center-preview" :style='{"width":"100%","padding":"0 10%","margin":"10px auto","position":"relative","background":"#fff"}'>
	...
	<div class="info" :style='{"padding":"20px 40px 40px 220px","margin":"20px auto","borderRadius":"0","flexWrap":"wrap","background":"#f9f9f9","display":"flex","width":"100%","position":"relative","height":"auto"}'>
		...
		<div :style='{"borderColor":"#efefef","top":"60px","left":"80px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='shangjia'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"100%","borderWidth":"0 0 1px 0","display":"block","width":"100px","borderStyle":"solid","float":"left","height":"100px"}' :src="sessionForm.yingyezhizhao?baseUrl + sessionForm.yingyezhizhao:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			...
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":"1"}'>{{sessionForm.yonghuzhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>用户姓名</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.yonghuxingming}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>手机号</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.shoujihao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>余额</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.money}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0 0 1px 0","background":"#FFFFFF","display":"flex","width":"40%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont " :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","margin":"0 10px 0 0","fontSize":"14px"}'>状态</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"left","flex":1}'>{{sessionForm.status}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"100%","background":"#f5f5f5","flexDirection":"column","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="110px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='yonghu'" label="手机号" prop="shoujihao">
          ...
          <el-form-item class="balance" :style='{"padding":"10px","margin":"0 0 10px"}' v-if="userTableName=='yonghu'" label="余额">
            <div :style='{"flexWrap":"wrap","display":"flex"}'>
				<el-input v-model="sessionForm.money" placeholder="余额" readonly></el-input>
				<div @click="dialogFormVisibleMoney = true" :style='{"border":"0","cursor":"pointer","padding":"0 15px","margin":"0 20px 0 10px","color":"rgba(255, 255, 255, 1)","display":"inline-block","outline":"none","borderRadius":"4px","background":"#654B3C","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}'>点我充值</div>
			</div>
		  </el-form-item>
